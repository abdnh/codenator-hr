            ...
            <Container>
                <Row>
                    <Col xs={5} className="left">
                        <Image className="d-none d-xl-block d-xxl-block" src="/svg/img1.svg" alt="" width={200} height={180} />
                    ...
                    <Col xs={6} className="right">
                        <Form className="form">
                            ...
                            {children}
                            <div className="icon">
                                <button><Image src="/svg/facebook.svg" alt="" width={30} height={30} /></button>
                                <button><Image src="/svg/google.svg" alt="" width={40} height={40} /></button>
                                <button><Image src="/svg/github.svg" alt="" width={30} height={30} /></button>
                            </div>
                        </Form>
                    </Col>
                </Row>
