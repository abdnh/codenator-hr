                ...
                <div className='content-body'>
                    ...
                    <Row>
                        <Col md={8}>
                            ...
                            <TextArea rows={2} style={{ marginBottom: "40px" }}/>
                        ...
                        <Col md={{ span: 3, offset: 1 }}>
                            ...
                            <div className="kategori" style={{ marginTop: "40px" }}>
                                <Card
                                    ...
                                    title="kategori seç" style={{ width: '100%', height: 240, background: '#F9F9F9' }}>
                                    <div>
                                        <div className='kategori-home'>
                                            <Checkbox onChange={onChange}>Ana Sayfa</Checkbox>
                                        </div>
                                        <div className='profil'>
                                            <Checkbox onChange={onChange}>Profil</Checkbox>
                                        </div>
